...
(defn set-comment
  ...
  ([^ZipEntry this ^java.lang.String comment]
...
(defn set-creation-time
  ...
  (^java.util.zip.ZipEntry [^ZipEntry this ^java.nio.file.attribute.FileTime time]
...
(defn to-string
  ...
  (^java.lang.String [^ZipEntry this]
    (-> this (.toString))))
...
(defn get-last-modified-time
  ...
  (^java.nio.file.attribute.FileTime [^ZipEntry this]
...
(defn clone
  ...
  (^java.lang.Object [^ZipEntry this]
    (-> this (.clone))))
